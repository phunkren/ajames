...
Back in 2020, I put together a list of basic principles for [working from home](https://ajames.dev/work-home). Where that focused on the ethos of working remotely, this time I’d like to discuss equipment that will allow you to be effective working in a remote environment. 
