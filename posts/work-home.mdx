...
5: Conference calls are synchronous; Slack/email is asynchronous. Get comfortable with both. Try to respond promptly regardless. Over-communicate and document outcomes.
