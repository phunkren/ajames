...
Learn to flex. Create a [brag list](https://blog.pragmaticengineer.com/work-log-template-for-software-engineers/) to document your accomplishments. A brag list is an invaluable tool for tracking your ([SMART](https://www.forbes.com/advisor/business/smart-goals/)) goals and helping you stay focused throughout the year. Continual progress simplifies demonstrating your value during performance reviews and promotion discussions. Rather than scrambling to recall earlier achievements before the packet submission, this living document will already offer all relevant information and context from when it was recorded. When [noting your accomplishments](https://www.umassglobal.edu/news-and-events/blog/writing-an-accomplishment-statement), make sure to highlight the existing problem, what you did to solve it, and the benefits of the result. 
...
If you enjoyed the article, or would like to discuss it further, hit me up on [Twitter](https://ajames.dev/twitter) or [LinkedIn](https://ajames.dev/linkedin). 
